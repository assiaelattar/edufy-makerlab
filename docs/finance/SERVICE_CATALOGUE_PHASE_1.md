...
- Auth/Firestore emulators with `demo-edufy-services`: repeatable imports, optimistic edits/archive/reactivation, snapshot persistence, idempotent issuance, independent F/S sequences with safe manual advancement and history recovery, corporate enrollment compatibility, full credit note, role/tenant/disabled-account/invalid-field/delete/nested-bypass denials.
