...
export const EnrollmentFormsView: React.FC<EnrollmentFormsViewProps> = ({ onEnrollLead }) => {
        ...
        <div className="p-8 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 relative">
            ...
            <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                <div>
                    ...
                    <p className="text-slate-500">Print enrollment forms or generate QR codes for Kiosk Mode.</p>
                </div>
            </div>
