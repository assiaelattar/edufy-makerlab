...
export const FinanceView = ({ onRecordPayment }: { onRecordPayment: (studentId?: string) => void }) => {
    ...
    const { filteredPayments, filteredEnrollments } = useMemo(() => {
        ...
        const matchesAudience = (progId: string) => {
        ...
        const pFiltered = payments.filter(p => {
            ...
            return matchesSession(p.session) &&
                ...
                matchesAudience(enrollment?.programId || '') &&
    ...
    }, [payments, enrollments, searchQuery, selectedSession, selectedProgram, dateRange, balanceFilter, transactionStatusFilter, settings.academicYear, filterAudience]);
    ...
    const stats = useMemo(() => {
        ...
        const baseEnrollments = enrollments.filter(e => {
            ...
            return e.status === 'active' && matchesSession && matchesProgram && matchesAudience();
        });
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                            ...
                            <div className="relative w-32 sm:w-40">
                                ...
                                <select value={filterAudience} onChange={(e) => setFilterAudience(e.target.value as any)} className="w-full pl-9 pr-4 py-2 bg-slate-950 border border-slate-800 text-slate-300 text-sm rounded-lg appearance-none focus:border-emerald-500 outline-none cursor-pointer truncate">
